...
public partial class MusicAtout_LSAVIOContext : DbContext
{
    public MusicAtout_LSAVIOContext()
    {
    }

    public MusicAtout_LSAVIOContext(DbContextOptions<MusicAtout_LSAVIOContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-6542KO35;Initial Catalog=MusicAtout_LSAVIO;Integrated Security=True;Encrypt=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdUtilisateur).HasName("PK__UTILISAT__5366DB1909C666FD");
